                                ...
                                <v-card>
                                    <v-alert outlined color="#365164">
                                        ...
                                        <v-card-text style="color: #000;" width="100%">
                                            <v-card class="mr-5 my-5 elevation-1" max-width="150" v-for="member in members" :key="member.index" style="display:inline-block">
                                                <v-img class="white--text align-end" height="150px" :src="studentImageURL+member.image"></v-img>
