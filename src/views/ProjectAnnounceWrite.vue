                            ...
                            <v-card>
                                <v-alert outlined color="#365164">
                                    <v-form>
                                        ...
                                        <v-row>
                                            <v-col cols="6">
                                                <v-text-field label="모집인원" required v-model="recruitment" @keypress="checkNumber" @keyup="checkHan"></v-text-field>
                                            </v-col>
                                            <v-col cols="6">
                                                <v-menu ref="menu" v-model="menu" :close-on-content-click="false" :return-value.sync="endDate" transition="scale-transition" offset-y min-width="290px">
                                        ...
                                        <v-row>
                                            <v-col cols="12">
                                                <v-textarea v-model="contents" outlined no-resize height="300" name="content-input" label="공고 내용을 입력하세요" />
                                            </v-col>
                                        </v-row>
